...
# Objective :
Part A: Predict the outcome of a new patient with high accuracy. Also, intent should also be to minimize
the number of false-negatives. 

Part B: Predict the recurrence time for patients whose outcome is R.
